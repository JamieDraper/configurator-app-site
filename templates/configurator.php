...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo $config->urls->templates?>styles/scrolling-nav.css?v=10" />
	</head>
	<body class="noselect">
	...
	<div id="php-echo-container">
		...
		$groups = $page->find('template=item-group, sort=sort');
	...
	<script src="<?php echo $config->urls->templates?>scripts/main.js?v=58"></script>
